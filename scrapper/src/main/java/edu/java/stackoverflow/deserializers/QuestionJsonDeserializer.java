...
public class QuestionJsonDeserializer extends JsonDeserializer<QuestionDTO> {
    @Override
    public QuestionDTO deserialize(JsonParser jsonParser, DeserializationContext deserializationContext)
        throws IOException {
